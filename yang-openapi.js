...
(function() {
  var Yang, clone, debug, definitions, discoverOperations, discoverParameters, discoverPaths, serializeJSchema, traverse, yaml, yang2jschema, yang2jsobj, yang2jstype;
  ...
  discoverOperations = function(schema, item) {
    var deprecated, ref1, ref2, ref3, ref4;
    if (item == null) {
      item = false;
    }
    if (typeof debug === "function") {
  ...
  discoverParameters = function(schema) {
